...
<table align="center" style="border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td width="60%" valign="top" style="border: none;">
      ...
      <p>
        🛸 <b>Multi-Rotor & Hexacopter Autonomy</b> | 🧠 <b>Multi-Sensor Fusion (EKF, LiDAR, IMU)</b> <br>
        🌪️ <b>Computational Fluid Dynamics (CFD)</b> | 🤖 <b>ROS-based Aerial Robotics & SLAM</b>
      </p>
    </td>
...
<table align="center" style="border: none; width: 100%;">
  <tr style="border: none;">
    <td width="33%" align="center" style="border: none;">
      <b>Hexacopter Gazebo Simulation</b><br><br>
      <img src="YOUR_GAZEBO_GIF_LINK_HERE" width="100%" style="border-radius: 8px;" alt="Hexacopter Gazebo Simulation" />
    </td>
    <td width="33%" align="center" style="border: none;">
      <b>3D Autonomous Flight Path</b><br><br>
      <img src="YOUR_3D_PLOT_LINK_HERE" width="100%" style="border-radius: 8px;" alt="3D Flight Path Plot" />
    </td>
    <td width="33%" align="center" style="border: none;">
      <b>Warehouse SLAM Architecture</b><br><br>
      <img src="YOUR_WAREHOUSE_PLAN_LINK_HERE" width="100%" style="border-radius: 8px;" alt="Warehouse Architecture Plan" />
    </td>
  </tr>
</table>
